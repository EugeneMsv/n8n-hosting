...
List of orders showing: order total (USD), item names, quantities, individual prices
Shorten each item name and use 'X <quantity>' to achieve the hard stop for 3072 symbols in the response
